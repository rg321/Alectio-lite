...
class Pipeline(object):
    ...
    def test(self, args):
        ...
        if self.type =="3DSegmentation":
            if "rangebased" in res:
                predictions_3D,labels_3D,predictions_2D,labels_2D,range_filtered, range_default = res["3Dpredictions"], res["3Dlabels"],res["2Dpredictions"], res["2Dlabels"],res["rangebased"] ,res["default"]
            else:
                predictions_3D, labels_3D,predictions_2D, labels_2D ,range_filtered ,range_default= res["3Dpredictions"], res["3Dlabels"],res["2Dpredictions"], res["2Dlabels"], None , None
        else:
        ...
        if "3D" in self.type:
            self.compute3D_metrics(predictions_3D, labels_3D,predictions_2D, labels_2D,range_filtered)
    ...
    def compute_metrics(self, predictions, ground_truth):
        ...
        if self.type == "Object Detection":
            ...
            raise Error("The selected task type is currently not supported")
